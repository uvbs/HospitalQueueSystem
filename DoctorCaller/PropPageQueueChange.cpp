...
IMPLEMENT_DYNAMIC(CPropPageQueueChange, CPropertyPage)

CPropPageQueueChange::CPropPageQueueChange(CString strDoctorId, CString strConn, CString strNurseId)
	: CPropertyPage(CPropPageQueueChange::IDD)
	, m_strConn(strConn)
...
CPropPageQueueChange::~CPropPageQueueChange()
{
}

void CPropPageQueueChange::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CPropPageQueueChange, CPropertyPage)
	ON_BN_CLICKED(IDC_BUTTON_ADD, &CPropPageQueueChange::OnBnClickedButtonAdd)
	ON_BN_CLICKED(IDC_BUTTON_REMOVE, &CPropPageQueueChange::OnBnClickedButtonRemove)
END_MESSAGE_MAP()


// CPropPageQueueChange 消息处理程序
BOOL CPropPageQueueChange::OnInitDialog()
{
...
//
void CPropPageQueueChange::RefreshQueue()
{
	try
	{
		CADODatabase db;
...
void CPropPageQueueChange::OnBnClickedButtonAdd()
{
...
void CPropPageQueueChange::OnBnClickedButtonRemove()
{
...
BOOL CPropPageQueueChange::OnApply()
{
